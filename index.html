...
<html>
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-69533863-2"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-69533863-2');
        </script>
        <meta charset="utf-8">
    ...
    <body data-spy="scroll" data-target=".navbar-collapse" style="overflow-y: hidden;">
        <div id="banner">
            <div class="slider">
            ...
            <div class="tint">
                <div class="welcome">
                    ...
                    <div class="col-lg-11 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12" style="left: 5%;">
                        <a href="https://www.facebook.com/avixweddings/" target="_blank" class="btn btn-default btn-lg"><i class="fab fa-facebook fa-lg"></i></a>
                        <a href="https://www.instagram.com/avixproductions/" target="_blank" class="btn btn-default btn-lg"><i class="fab fa-instagram fa-lg"></i></a>
